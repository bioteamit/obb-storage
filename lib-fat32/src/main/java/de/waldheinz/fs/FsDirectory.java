...
public interface FsDirectory extends Iterable<FsDirectoryEntry>, FsObject {
     ...
     */
    FsDirectoryEntry getEntry(String name) throws IOException;
     ...
     */
    FsDirectoryEntry addFile(String name) throws IOException;
     ...
     */
    FsDirectoryEntry addDirectory(String name) throws IOException;
